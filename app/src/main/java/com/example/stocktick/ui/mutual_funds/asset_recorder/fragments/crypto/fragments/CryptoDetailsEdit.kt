...
import com.example.stocktick.databinding.FragmentCryptoDetailsEditBinding
...
class CryptoDetailsEdit : Fragment(R.layout.fragment_crypto_details_edit) {
    private lateinit var binding: FragmentCryptoDetailsEditBinding
    private val viewModel: CryptoViewModel by activityViewModels()
    private val args: CryptoDetailsEditArgs by navArgs()

    private var position : Int = -1

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding = FragmentCryptoDetailsEditBinding.bind(view)
