...
import com.example.stocktick.databinding.FragmentPmsDetailsEditBinding
...
class PmsDetailsEdit : Fragment(R.layout.fragment_pms_details_edit) {
    private lateinit var binding: FragmentPmsDetailsEditBinding
    private val viewModel: PmsViewModel by activityViewModels()
    private val args: PmsDetailsEditArgs by navArgs()

    private var position : Int = -1

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding = FragmentPmsDetailsEditBinding.bind(view)
