...
import com.example.stocktick.databinding.FragmentUsDetailsEditBinding
...
class UsDetailsEdit : Fragment(R.layout.fragment_us_details_edit) {
    private lateinit var binding: FragmentUsDetailsEditBinding
    private val viewModel: UsViewModel by activityViewModels()
    private val args: UsDetailsEditArgs by navArgs()

    private var position : Int = -1

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding = FragmentUsDetailsEditBinding.bind(view)
