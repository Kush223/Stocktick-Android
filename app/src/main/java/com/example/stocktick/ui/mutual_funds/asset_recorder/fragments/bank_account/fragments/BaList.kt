...
import com.example.stocktick.databinding.FragmentBaListBinding
import com.example.stocktick.ui.mutual_funds.asset_recorder.fragments.bank_account.BaAdapter
import com.example.stocktick.ui.mutual_funds.asset_recorder.fragments.bank_account.BaViewModel
import kotlinx.coroutines.flow.collect
import kotlinx.coroutines.launch


private const val TAG = "BaList"
class BaList : Fragment(R.layout.fragment_ba_list) {

    private lateinit var binding: FragmentBaListBinding
    private lateinit var recyclerView : RecyclerView

    private val viewModel : BaViewModel by activityViewModels()

    private lateinit var adapter: BaAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentBaListBinding.bind(view)
        ...
        adapter = BaAdapter(
            ...
            onClick = {
                val action =
                    BaListDirections.actionBaListToBaDetais(it)
        ...
        binding.fabEdit.setOnClickListener{
            val action = BaListDirections.actionBaListToBaDetailsEdit(-1)
            view.findNavController().navigate(action)
        }
