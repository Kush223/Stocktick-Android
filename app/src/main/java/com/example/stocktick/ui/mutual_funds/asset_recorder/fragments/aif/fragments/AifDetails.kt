...
import com.example.stocktick.databinding.FragmentAifDetailsBinding
...
class AifDetails : Fragment( R.layout.fragment_aif_details) {

    private lateinit var binding: FragmentAifDetailsBinding
    private val viewModel : AifViewModel by activityViewModels()

    private val args: AifDetailsArgs by navArgs()

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val navController = view.findNavController()
        binding = FragmentAifDetailsBinding.bind(view)
        ...
        binding.fabEdit.setOnClickListener{
            val action = AifDetailsDirections.actionAifDetailsToAifDetailsEdit(args.position)
