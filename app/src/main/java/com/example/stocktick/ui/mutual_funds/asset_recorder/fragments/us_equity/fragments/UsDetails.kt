...
import com.example.stocktick.databinding.FragmentUsDetailsBinding
...
class UsDetails : Fragment( R.layout.fragment_us_details) {

    private lateinit var binding: FragmentUsDetailsBinding
    private val viewModel : UsViewModel by activityViewModels()

    private val args: UsDetailsArgs by navArgs()

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val navController = view.findNavController()
        binding = FragmentUsDetailsBinding.bind(view)
        val details : UsModel? = try {
        ...
        binding.fabEdit.setOnClickListener{
            val action = UsDetailsDirections.actionUsDetailsToUsDetailsEdit(args.position)
