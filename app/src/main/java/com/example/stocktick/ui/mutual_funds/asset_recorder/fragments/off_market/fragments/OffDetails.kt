...
import com.example.stocktick.databinding.FragmentOffDetailsBinding
...
class OffDetails : Fragment( R.layout.fragment_off_details) {

    private lateinit var binding: FragmentOffDetailsBinding
    private val viewModel : OffViewModel by activityViewModels()

    private val args: OffDetailsArgs by navArgs()

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val navController = view.findNavController()
        binding = FragmentOffDetailsBinding.bind(view)
        ...
        binding.fabEdit.setOnClickListener{
            val action = OffDetailsDirections.actionOffDetailsToOffDetailsEdit(args.position)
