...
import com.example.stocktick.databinding.FragmentEquityDetailsEditBinding
...
class EquityDetailsEdit : Fragment(R.layout.fragment_equity_details_edit) {
    private lateinit var binding: FragmentEquityDetailsEditBinding
    private val viewModel: EquityViewModel by activityViewModels()
    private val args: EquityDetailsEditArgs by navArgs()

    private var position : Int = -1

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding = FragmentEquityDetailsEditBinding.bind(view)
