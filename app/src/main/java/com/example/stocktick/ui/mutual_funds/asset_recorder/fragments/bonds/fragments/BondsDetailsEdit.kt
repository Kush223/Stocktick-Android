...
import com.example.stocktick.databinding.FragmentBondsDetailsEditBinding
...
class BondsDetailsEdit : Fragment(R.layout.fragment_bonds_details_edit) {
    private lateinit var binding: FragmentBondsDetailsEditBinding
    private val viewModel: BondsViewModel by activityViewModels()
    private val args: BondsDetailsEditArgs by navArgs()

    private var position : Int = -1

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding = FragmentBondsDetailsEditBinding.bind(view)
