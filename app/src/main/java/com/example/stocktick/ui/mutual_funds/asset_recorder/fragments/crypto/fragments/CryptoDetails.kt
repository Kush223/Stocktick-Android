...
import com.example.stocktick.databinding.FragmentCryptoDetailsBinding
...
class CryptoDetails : Fragment( R.layout.fragment_crypto_details) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.fabEdit.setOnClickListener{
            val action = CryptoDetailsDirections.actionCryptoDetailsToCryptoDetailsEdit(args.position)
